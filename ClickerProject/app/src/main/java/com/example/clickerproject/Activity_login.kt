...
class Activity_login : AppCompatActivity() {
    ...
    fun loginInDataBase(view: View) {
        try {
            ...
            val email =
                findViewById<TextView>(R.id.editTextEmail).toString() // Replace with the email input field value
            val password =
                findViewById<TextView>(R.id.editTextPassword).toString()// Replace with the password input field value
